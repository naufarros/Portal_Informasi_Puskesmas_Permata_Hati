	...
	<div class="container pt-5">
		<div class="row justify-content-center text-center mb-4 mb-md-5">
			<div class="col-xl-9 col-xxl-8">
				...
				<h2 class="display-5 fw-bold">Informasi Jumlah Tempat Tidur</h2>
				<p class="lead">Memberikan informasi tentang jumlah tempat tidur yang disediakan di Puskesmas Permata Hati</p>
			</div>
		</div>
